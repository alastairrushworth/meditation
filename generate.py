...
"""
    ...
    <script>
        ...
        function applyFilters() {{
            ...
            meditations.forEach(meditation => {{
                ...
                if (podcastMatch && searchMatch) {{
                    ...
                    if (searchTerm) {{
                        ...
                        descriptionElement.innerHTML = highlightText(originalDescription, searchTerm);
                    }} else {{
            ...
            if (totalText && visibleCount < {total_count}) {{
                resultCount.textContent = `Showing ${{visibleCount}} of ${{totalText}} meditations`;
            }} else {{
                resultCount.textContent = `Showing ${{visibleCount}} meditation${{visibleCount !== 1 ? 's' : ''}}`;
            }}
        }}
